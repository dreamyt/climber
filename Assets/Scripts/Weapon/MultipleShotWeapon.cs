...
public class MultipleShotWeapon : Weapon
{
    ...
    private void SpawnProjectile(Vector2 direction)
    {
        ...
        projectile.SetDirection(WeaponOwner.GetComponent<Movement>().side==1? Vector2.right + direction : Vector2.left + direction);
    ...
    {
        if (WeaponOwner.GetComponent<Movement>().side==1)
        {
            // Right side
